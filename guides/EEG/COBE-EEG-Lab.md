...
- [ ] Measure head size:
  ...
  - [ ] Now place the cap on the subjects' head (be careful not to touch the electrodes, try to hold cap from inside)
...
- [ ] Prepare the cap for gelling & impedance monitoring:
  - [ ] Turn on the recording software
...
- [ ] Then gel all other electrodes (each one should turn green, light (=10kOhm) is optimal, dark(=20kOhm) is acceptable)
